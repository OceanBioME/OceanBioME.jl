@inline function (bgc::PISCES{<:Any, <:Any, <:Any, TwoCompartementCarbonIronParticles})(i, j, k, grid, val_name::Val{:PSi}, clock, fields)
    ...
    phytoplankton_production = particulate_silicate_production(bgc.phytoplankton, i, j, k, grid, bgc, clock, fields)
...
@inline function particulate_silicate_dissolution(poc::TwoCompartementCarbonIronParticles, i, j, k, grid, bgc, clock, fields)
    ...
    χ = particulate_silicate_liable_fraction(poc, i, j, k, grid, bgc, clock, fields)
...
@inline function particulate_silicate_liable_fraction(poc, i, j, k, grid, bgc, clock, fields)
    ...
    wGOC = ℑzᵃᵃᶜ(i, j, k, grid, fields.wGOC) # this isn't actually correct since wGOC isn't constant but nm
