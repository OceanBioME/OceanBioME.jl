...
@inline (lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Any, <:CarbonateSystem})(i, j, k, grid, ::Val{:DIC}, clock, fields, auxiliary_fields) = (
...
@inline (lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Any, <:CarbonateSystem})(i, j, k, grid, ::Val{:Alk}, clock, fields, auxiliary_fields) = (
    nutrient_uptake(lobster, i, j, k, Val(:NO₃), fields, auxiliary_fields)
  - calcite_uptake(lobster, i, j, k, fields, auxiliary_fields)
)

@inline (lobster::NutrientsBiologyDetritus{<:Nutrient, <:Any, <:Any, <:CarbonateSystem})(i, j, k, grid, ::Val{:Alk}, clock, fields, auxiliary_fields) = (
