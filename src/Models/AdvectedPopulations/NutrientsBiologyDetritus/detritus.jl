...
@kwdef struct TwoParticleAndDissolved{FT, SS, LS}
    remineralisation_inorganic_fraction :: FT = 0.0     # 
             small_remineralisation_rate :: FT = 5.88e-7 # 1/s
             large_remineralisation_rate :: FT = 5.88e-7 # 1/s
         dissolved_remineralisation_rate :: FT = 3.86e-7 # 1/s
...
@inline (lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:VariableRedfieldDetritus})(i, j, k, grid, val_name::Val{:sPOC}, clock, fields, auxiliary_fields) = (
...
@inline (lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:VariableRedfieldDetritus})(i, j, k, grid, ::Val{:bPOC}, clock, fields, auxiliary_fields) = (
...
@inline (lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:VariableRedfieldDetritus})(i, j, k, grid, ::Val{:DOC}, clock, fields, auxiliary_fields) = (
...
const TWO_PARTICLE_SIZE_LOBSTER = Union{NutrientsBiologyDetritus{<:Any, <:Any, <:TwoParticleAndDissolved}, NutrientsBiologyDetritus{<:Any, <:Any, <:VariableRedfieldDetritus}}
const TWO_PARTICLE_SIZES = Union{TwoParticleAndDissolved, VariableRedfieldDetritus}

const SMALL_SINKING_OFF =  Union{NutrientsBiologyDetritus{<:Any, <:Any, <:TwoParticleAndDissolved{<:Any, Nothing}}, 
                                 NutrientsBiologyDetritus{<:Any, <:Any, <:VariableRedfieldDetritus{<:Any, Nothing}}}

const LARGE_SINKING_OFF =  Union{NutrientsBiologyDetritus{<:Any, <:Any, <:TwoParticleAndDissolved{<:Any, <:Any, Nothing}}, 
                                 NutrientsBiologyDetritus{<:Any, <:Any, <:VariableRedfieldDetritus{<:Any, <:Any, Nothing}}}
...
@inline (lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Detritus})(i, j, k, grid, val_name::Val{:D}, clock, fields, auxiliary_fields) =
    @inbounds (
        biology_organic_nitrogen_waste(lobster, i, j, k, fields, auxiliary_fields)
...
biogeochemical_drift_velocity(lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Detritus}, ::Val{:D}) = 
...
@inline detritus_inorganic_nitrogen_waste(lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Detritus}, i, j, k, fields, auxiliary_fields) =
    @inbounds fields.D[i, j, k] * lobster.detritus.remineralisation_rate

@inline detritus_inorganic_carbon_waste(lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Detritus}, i, j, k, fields, auxiliary_fields) =
...
# close the loop
@inline detritus_inorganic_nitrogen_waste(lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Nothing}, i, j, k, fields, auxiliary_fields) = 
    (biology_organic_nitrogen_waste(lobster, i, j, k, fields, auxiliary_fields)
      + solid_waste(lobster, i, j, k, fields, auxiliary_fields))

@inline detritus_inorganic_carbon_waste(lobster::NutrientsBiologyDetritus{<:Any, <:Any, <:Nothing}, i, j, k, fields, auxiliary_fields) = 
    (biology_organic_nitrogen_waste(lobster, i, j, k, fields, auxiliary_fields)
