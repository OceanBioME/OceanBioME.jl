...
@inline (bgc::NPD_AIC)(i, j, k, grid, ::Val{:DIC}, clock, fields, auxiliary_fields) = (
  - primary_production(i, j, k, grid, bgc.plankton, bgc, i, j, k, fields, auxiliary_fields)
  + inorganic_carbon_waste(i, j, k, grid, bgc.plankton, bgc, i, j, k, fields, auxiliary_fields)
  + inorganic_carbon_waste(i, j, k, grid, bgc.detritus, bgc, i, j, k, fields, auxiliary_fields)
  - net_calcite_production(i, j, k, grid, bgc, i, j, k, fields, auxiliary_fields)
)
