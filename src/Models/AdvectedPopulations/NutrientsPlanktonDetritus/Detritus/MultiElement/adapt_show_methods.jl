function Adapt.adapt_structure(to, d::RefractoryDissolvedParticulateCNP{FT}) where FT
    sinking_velocities = adapt(to, d.sinking_velocities)

    return RefractoryDissolvedParticulateCNP{FT,
...
Base.summary(::RefractoryDissolvedParticulateCNP) =
    "RefractoryDissolvedParticulateCNP (DOC/DON/DOP, DOCr/DONr/DOPr, POC/POP/PFe, bSi)"

function Base.show(io::IO, d::RefractoryDissolvedParticulateCNP)
    msg  = summary(d) * "\n"
