...
For details of the BGC models currently implemented please see the following pages. LOBSTER, NPZD, ImplicitBiology, and WTSP are all built on a common [Nutrients-Plankton-Detritus framework](@ref npd_framework) that allows mixing and matching of component types.
