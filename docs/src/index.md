...
OceanBioME.jl currently provides a core of several biogeochemical models (Nutrient--Phytoplankton--Zooplankton--Detritus (NPZD) and [LOBSTER](https://doi.org/10.1029/2004JC002588), a medium complexity model, and air-sea gas exchange models to provide appropriate top boundary conditions. [PISCES](https://doi.org/10.5194/gmd-8-2465-2015) and also sediment models for the benthic boundary are in our future development plans.
