...
model = BoxModel(; biogeochemistry = PISCES(; grid, 
                                              light_attenuation_model = PrescribedPhotosyntheticallyActiveRadiation((; PAR, PAR₁, PAR₂, PAR₃),
                                              ), 
                   mixed_layer_depth = zₘₓₗ, euphotic_depth = zₑᵤ),
                   clock)
