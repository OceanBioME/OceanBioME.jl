...
function test_flat_sediment(architecture)
    ...
    set!(model.biogeochemistry.sediment_model.N_fast, 30.0)
    set!(model.biogeochemistry.sediment_model.N_slow, 30.0)

    set!(model.biogeochemistry.sediment_model.C_fast, 30.0 * model.biogeochemistry.organic_redfield)
    set!(model.biogeochemistry.sediment_model.C_slow, 30.0 * model.biogeochemistry.organic_redfield)
