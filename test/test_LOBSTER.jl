...
@testset "Realistic Values" begin
    ...
    dD = test_forcing(LOBSTER.D_forcing(0, 0, -1, 0, NO₃, NH₄, P, Z, D, DD, DOM, PAR, LOBSTER.defaults))
    dDD = test_forcing(LOBSTER.DD_forcing(0, 0, -1, 0, NO₃, NH₄, P, Z, D, DD, DOM, PAR, LOBSTER.defaults))
